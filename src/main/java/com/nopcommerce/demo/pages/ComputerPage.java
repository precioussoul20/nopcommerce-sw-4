...
import com.nopcommerce.demo.utlilities.Utility;
...
public class ComputerPage extends Utility {
    ...
    public void changeQuantity(){
        sentTextToElement(quantity, Keys.BACK_SPACE + "2");
    }
    ...
    public void inputFirstname(String firstname){
        sentTextToElement(firstNameTextBox, firstname);
    }
    public void inputLastname(String lastname){
        sentTextToElement(lastNameTextBox, lastname);
    }
    public void inputEmail(String email){
        sentTextToElement(emailTextBox, email);
    }
    public void selectCountry(String countryname){
        selectByVisibleTextFromDropDown(countryDropdown,countryname);
    }
    public void inputCity(String cityname){
        sentTextToElement(cityTextBox,cityname);
    }
    public void inputAddress1(String address){
        sentTextToElement(address1TextBox,address);
    }
    public void inputPostalCode(String postcode){
        sentTextToElement(postalcodeTextBox,postcode);
    }
    public void inputPhoneNumber(String phone){
        sentTextToElement(phoneNumberTextBox,phone);
    }
    ...
    public void inputCardHolderName(String holdername) {
        sentTextToElement(cardHolderName,holdername);
    }
    public void inputCardNumber(String card){
        sentTextToElement(cardNumber, card);
    }
    ...
    public void inputCardCode(String cvc){
        sentTextToElement(cardCode,cvc);
    }
