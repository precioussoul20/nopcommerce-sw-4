...
public class ElectronicsTest extends TestBase {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        register.inputFirstname("Priya");
        register.inputLastname("Patel");
        register.inputEmail("PriyaPatel1244@gmail.com");
        register.inputPassword("Priya1234");
        register.inputConfirmPassword("Priya1234");
        ...
        sentTextToElement(By.xpath("//input[@id='Email']"),"PrimePatel124@gmail.com");
        sentTextToElement(By.xpath("//input[@id='Password']"),"Prime1234");
        ...
        checkout.inputFirstname("Priya");
        checkout.inputLastname("Patel");
        checkout.inputEmail("PriyaPatel124@gmail.com");
        ...
        checkout.inputCardHolderName("Mr Priya Patel");
